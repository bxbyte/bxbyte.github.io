export default {
	id: 'cea',
	name: "Stage - Outils d'analyse automatique d'acquisitions en imagerie gamma",
	coorp: {
		name: 'CEA',
		location: '38000 Grenoble',
		logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-hufhfIRLXVjrdBXHfzfV7I1lZ-ZKQIy4_Q&s',
	},
	letter: {
		object:
