...
export default {
	...
	letter: {
		...
		object: "Candidature de stage - Outils d'analyse automatique d'acquisitions en imagerie gamma",
		from: "Grenoble",
		content: `
			Madame, Monsieur,
	...
	cv: {
		object: "Stage - Outils d'analyse automatique d'acquisitions en imagerie gamma",
		description: `
