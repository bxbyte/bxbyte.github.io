export default {
	id: "st",
	cv: {
		object: "Étudiant en informatique - Recherche de stage",
		description: `
			Étudiant passionné de technologie en deuxième année de BUT Informatique,
			je suis à la recherche d'un sujet de stage autour du développement d'application.
			Étant curieux et dynamique, je suis impatient à l'idée de réaliser
			ce stage pour enfin y découvrir les réalités du métier sous ses divers
			facettes.
		`,
		skills: [
			[
