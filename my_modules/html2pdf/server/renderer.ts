...
export default class Renderer {
	...
	static serverDir: string
	static clientDir: string
	...
	static async setup({
		...
		this.gsPath = gsPath
		this.serverDir = join(config.publicDir.pathname, config.build.assets)
		this.clientDir = '/' + config.build.assets
	...
	static async render(
		...
		const tempDir = mkdtempSync(join(tmpdir(), 'renderer')),
			...
			renderServerDir = join(this.serverDir, hashDir)
		...
		return join(this.clientDir, hashDir, filepath)
	}
}
